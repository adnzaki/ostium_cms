...
$base_url="http://localhost:8080/ostium_cms"; //url base of site if you want only relative url leave empty
$upload_dir = '/assets/uploads/'; // path from base_url to upload base dir
$current_path = $base_url; // relative path from filemanager folder to upload files folder
